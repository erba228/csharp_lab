...
partial class SelectionSortDescriptionForm
{
    ...
    #region Windows Form Designer generated code
        ...
        private void InitializeComponent()
        {
            ...
            this.pictureBox.Image = Image.FromFile(@"C:\Users\User\Desktop\algorithms_via_winforms\selection_sort.gif"); 
            this.pictureBox.SizeMode = PictureBoxSizeMode.StretchImage; 
            this.pictureBox.Dock = DockStyle.Bottom; 
            this.pictureBox.Height = 200; 
            this.Controls.Add(pictureBox);
            this.Controls.Add(this.textBoxDescription);
            this.Name = "SelectionSortDescriptionForm";
            this.Text = "Описание алгоритма Selection Sort";
            this.Load += new System.EventHandler(this.SelectionSortDescriptionForm_Load);
