...
partial class PyramidSortForm
{
    ...
    private void InitializeComponent()
    {
        ...
        this.labelIteration.Location = new System.Drawing.Point(70, 200);        
        this.labelIteration.Text = "Итерации:"; 
        ...
        this.Text = "Пирамидная сортировка (Pyramid Sort)";
        ...
        this.ResumeLayout(false); // Add the list box for iterations
    }
